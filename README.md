...
Designed as a back-office request tracker for financial operations, trade support, and back-office teams.
...
> | Operations User | ops@finopsflow.com | Ops1234! |
...
### Request Details
![Request Details](docs/screenshots/details.png)
...
- Automatic storage switching: local file system (dev) vs Azure Blob Storage (production)
...
- Admin audit log page with filtering by user, action, and date range
